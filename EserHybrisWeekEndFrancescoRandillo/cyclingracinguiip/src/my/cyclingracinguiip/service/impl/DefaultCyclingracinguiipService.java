...
public class DefaultCyclingracinguiipService implements CyclingracinguiipService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultCyclingracinguiipService.class);
	...
	{
		return DefaultCyclingracinguiipService.class.getResourceAsStream("/cyclingracinguiip/sap-hybris-platform.png");
	}
