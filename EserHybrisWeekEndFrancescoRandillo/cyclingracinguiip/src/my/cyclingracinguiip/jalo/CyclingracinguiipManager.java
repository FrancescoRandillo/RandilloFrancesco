...
/**
 * This is the extension manager of the Cyclingracinguiip extension.
 */
public class CyclingracinguiipManager extends GeneratedCyclingracinguiipManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(CyclingracinguiipManager.class);
	 ...
	 */
	public static CyclingracinguiipManager getInstance()
	{
		return (CyclingracinguiipManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CyclingracinguiipConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CyclingracinguiipManager() // NOPMD 
	{
		LOG.debug("constructor of CyclingracinguiipManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of CyclingracinguiipManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of CyclingracinguiipManager called, current tenant: {}", getTenant().getTenantID());
	}
