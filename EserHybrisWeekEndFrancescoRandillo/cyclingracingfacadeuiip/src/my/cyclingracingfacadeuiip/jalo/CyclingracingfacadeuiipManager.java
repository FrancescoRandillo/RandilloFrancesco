 ...
 */
package my.cyclingracingfacadeuiip.jalo;
...
/**
 * This is the extension manager of the Cyclingracingfacadeuiip extension.
 */
public class CyclingracingfacadeuiipManager extends GeneratedCyclingracingfacadeuiipManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(CyclingracingfacadeuiipManager.class);
	 ...
	 */
	public static CyclingracingfacadeuiipManager getInstance()
	{
		return (CyclingracingfacadeuiipManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CyclingracingfacadeuiipConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CyclingracingfacadeuiipManager() // NOPMD 
	{
		LOG.debug("constructor of CyclingracingfacadeuiipManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of CyclingracingfacadeuiipManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of CyclingracingfacadeuiipManager called, current tenant: {}", getTenant().getTenantID());
	}
