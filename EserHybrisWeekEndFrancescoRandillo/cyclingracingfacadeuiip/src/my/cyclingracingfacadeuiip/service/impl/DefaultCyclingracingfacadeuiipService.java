...
public class DefaultCyclingracingfacadeuiipService implements CyclingracingfacadeuiipService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultCyclingracingfacadeuiipService.class);
	...
	{
		return DefaultCyclingracingfacadeuiipService.class.getResourceAsStream("/cyclingracingfacadeuiip/sap-hybris-platform.png");
	}
