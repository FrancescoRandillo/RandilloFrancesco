 ...
 */
package my.cyclistracingfrontend.jalo;
...
/**
 * This is the extension manager of the Cyclistracingfrontend extension.
 */
public class CyclistracingfrontendManager extends GeneratedCyclistracingfrontendManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(CyclistracingfrontendManager.class);
	 ...
	 */
	public static CyclistracingfrontendManager getInstance()
	{
		return (CyclistracingfrontendManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CyclistracingfrontendConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CyclistracingfrontendManager() // NOPMD 
	{
		LOG.debug("constructor of CyclistracingfrontendManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of CyclistracingfrontendManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of CyclistracingfrontendManager called, current tenant: {}", getTenant().getTenantID());
	}
