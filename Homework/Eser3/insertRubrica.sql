...
# DUMPING AddressBook
# #####################
#insert values in the table country
INSERT INTO country (code, name) VALUES
					...
					('IT', 'Italy'),
                    ('FR', 'France');
#insert values in the table brand
...
INSERT INTO user(id, name,surname,dateOfBirth, address,mobile,phone,email,smartphone) VALUES
						(1,'francesco','randillo','1994-10-19','ariano irpino','+39 3468315563','0825891794','francescorandillo@live.it',5),
						(2,'simona','palumbo','1992-02-21','casoria','+39 3368456879','0824879584','simonapalumbo@hotmail.it',5),
						(3,'francesco','caniglia','1991-8-10','brindisi','+39 3395578956','085796547','francescocaniglia@live.it',2),
						(4,'francesco','riccardo','1988-7-9','monteforte','+39 3336655888','0845784632','francescoriccardo@live.it',3),
						(5,'francesco','vietri','1988-10-5','montoro','+39 3225577987','0814569875','francescovietri@live.it',7),
						(6,'silverio','vaira','1988-2-14','castelnuovo della daunia','+39 3556251847','0878541236','silveriovaira@live.it',4),
						(7,'antonia','coviello','1991-5-14','caserta','+39 3335141987','0898765432','antoniacoviello@live.it',10),
						(8,'mario','saponara','1985-8-17','pestum','+39 35578+4561','0812345687','mariosaponara@live.it',7),
						(9,'francesca','di mare','1981-9-30','pozzuoli','+39 3896512457','0878451295','francescadimare@live.it',5),
						(10,'angelo','giordano','1988-4-7','montoro','+39 3547895412','0855447789','angelogiordano@live.it',11);
