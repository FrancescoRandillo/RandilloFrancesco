...
public class DefaultHospitaluiipfacadeService implements HospitaluiipfacadeService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultHospitaluiipfacadeService.class);
	...
	{
		return DefaultHospitaluiipfacadeService.class.getResourceAsStream("/hospitaluiipfacade/sap-hybris-platform.png");
	}
