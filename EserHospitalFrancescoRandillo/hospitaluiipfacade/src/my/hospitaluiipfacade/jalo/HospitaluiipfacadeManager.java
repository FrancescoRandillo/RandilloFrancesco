 ...
 */
package my.hospitaluiipfacade.jalo;
...
/**
 * This is the extension manager of the Hospitaluiipfacade extension.
 */
public class HospitaluiipfacadeManager extends GeneratedHospitaluiipfacadeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(HospitaluiipfacadeManager.class);
	 ...
	 */
	public static HospitaluiipfacadeManager getInstance()
	{
		return (HospitaluiipfacadeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(HospitaluiipfacadeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public HospitaluiipfacadeManager() // NOPMD 
	{
		LOG.debug("constructor of HospitaluiipfacadeManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of HospitaluiipfacadeManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of HospitaluiipfacadeManager called, current tenant: {}", getTenant().getTenantID());
	}
