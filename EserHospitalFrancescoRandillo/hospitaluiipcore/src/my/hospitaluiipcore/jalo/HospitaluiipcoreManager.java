...
/**
 * This is the extension manager of the Hospitaluiipcore extension.
 */
public class HospitaluiipcoreManager extends GeneratedHospitaluiipcoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(HospitaluiipcoreManager.class);
	 ...
	 */
	public static HospitaluiipcoreManager getInstance()
	{
		return (HospitaluiipcoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(HospitaluiipcoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public HospitaluiipcoreManager() // NOPMD 
	{
		LOG.debug("constructor of HospitaluiipcoreManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of HospitaluiipcoreManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of HospitaluiipcoreManager called, current tenant: {}", getTenant().getTenantID());
	}
