...
public class DefaultHospitaluiipcoreService implements HospitaluiipcoreService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultHospitaluiipcoreService.class);
	...
	{
		return DefaultHospitaluiipcoreService.class.getResourceAsStream("/hospitaluiipcore/sap-hybris-platform.png");
	}
