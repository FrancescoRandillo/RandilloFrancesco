 ...
 */
package my.hospitaluiipcore.controller;
...
@Controller
public class HospitaluiipcoreHelloController
{
	@Autowired
	...
	{
		model.addAttribute("logoUrl", hospitaluiipcoreService.getHybrisLogoUrl(PLATFORM_LOGO_CODE));
		return "welcome";
	}
}
