...
public class DefaultHospitaluiipfrontendService implements HospitaluiipfrontendService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultHospitaluiipfrontendService.class);
	...
	{
		return DefaultHospitaluiipfrontendService.class.getResourceAsStream("/hospitaluiipfrontend/sap-hybris-platform.png");
	}
