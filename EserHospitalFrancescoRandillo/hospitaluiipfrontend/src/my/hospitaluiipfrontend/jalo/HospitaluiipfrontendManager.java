 ...
 */
package my.hospitaluiipfrontend.jalo;
...
/**
 * This is the extension manager of the Hospitaluiipfrontend extension.
 */
public class HospitaluiipfrontendManager extends GeneratedHospitaluiipfrontendManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(HospitaluiipfrontendManager.class);
	 ...
	 */
	public static HospitaluiipfrontendManager getInstance()
	{
		return (HospitaluiipfrontendManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(HospitaluiipfrontendConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public HospitaluiipfrontendManager() // NOPMD 
	{
		LOG.debug("constructor of HospitaluiipfrontendManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of HospitaluiipfrontendManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of HospitaluiipfrontendManager called, current tenant: {}", getTenant().getTenantID());
	}
