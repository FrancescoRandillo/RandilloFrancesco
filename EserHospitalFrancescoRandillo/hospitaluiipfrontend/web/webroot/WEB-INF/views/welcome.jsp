...
<html>
<head>
    <title>Welcome to hospitaluiipfrontend</title>
    <link rel="stylesheet" href="<c:url value="/static/hospitaluiipfrontend-webapp.css"/>" type="text/css"
          media="screen, projection"/>
</head>
<div class="container">
    <img src="<c:url value="${logoUrl}" />" alt="Hybris platform logo"/>

    <h2>Welcome to "hospitaluiipfrontend" extension</h2>
    ...
    <div>
        ...
        <ul>
            <li><b>resources/hospitaluiipfrontend-items.xml</b> - here you can model your items</li>
            <li><b>resources/hospitaluiipfrontend-spring.xml</b> - here you can define your services</li>
            <li><b>web/webroot/WEB-INF/config/hospitaluiipfrontend-spring-mvc-config.xml</b> - here is a Spring MVC related
                configuration
            </li>
            <li><b>web/webroot/WEB-INF/config/hospitaluiipfrontend-web-app-config.xml</b> - here you can define web related services,
                facades etc.
            </li>
            <li><b>web/webroot/WEB-INF/config/hospitaluiipfrontend-spring-security-config.xml</b> - here you can configure your Spring Security settings</li>
